...
{
public:
	M2kCrossingDetection(double level, double hysteresis_span, const QString &name)
	...
	, m_harmonics_number(5)
{
	...
	if(m_isTimeDomain) {
		...
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("Period"), M2kMeasurementData::HORIZONTAL, "s", channel));
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("Frequency"), M2kMeasurementData::HORIZONTAL, "Hz", channel));
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("Min"), M2kMeasurementData::VERTICAL, "V", channel));
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("Max"), M2kMeasurementData::VERTICAL, "V", channel));
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("Peak-peak"), M2kMeasurementData::VERTICAL, "V", channel));
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("Mean"), M2kMeasurementData::VERTICAL, "V", channel));
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("Cycle Mean"), M2kMeasurementData::VERTICAL, "V", channel));
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("RMS"), M2kMeasurementData::VERTICAL, "V", channel));
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("Cycle RMS"), M2kMeasurementData::VERTICAL, "V", channel));
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("AC RMS"), M2kMeasurementData::VERTICAL, "V", channel));
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("Area"), M2kMeasurementData::VERTICAL, "Vs", channel));
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("Cycle Area"), M2kMeasurementData::VERTICAL, "Vs", channel));
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("Low"), M2kMeasurementData::VERTICAL, "V", channel));
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("High"), M2kMeasurementData::VERTICAL, "V", channel));
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("Amplitude"), M2kMeasurementData::VERTICAL, "V", channel));
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("Middle"), M2kMeasurementData::VERTICAL, "V", channel));
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("+Over"), M2kMeasurementData::VERTICAL, "%", channel));
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("-Over"), M2kMeasurementData::VERTICAL, "%", channel));
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("Rise"), M2kMeasurementData::HORIZONTAL, "s", channel));
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("Fall"), M2kMeasurementData::HORIZONTAL, "s", channel));
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("+Width"), M2kMeasurementData::HORIZONTAL, "s", channel));
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("-Width"), M2kMeasurementData::HORIZONTAL, "s", channel));
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("+Duty"), M2kMeasurementData::HORIZONTAL, "%", channel));
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			QObject::tr("-Duty"), M2kMeasurementData::HORIZONTAL, "%", channel));
	} else {
		// Spectral Measurements
		m_measurements.push_back(std::make_shared<M2kMeasurementData>(
			"Noise_Floor", M2kMeasurementData::HORIZONTAL_F, "dB", channel));
		m_measurements.push_back(
			std::make_shared<M2kMeasurementData>("SINAD", M2kMeasurementData::HORIZONTAL_F, "dB", channel));
		m_measurements.push_back(
			std::make_shared<M2kMeasurementData>("SNR", M2kMeasurementData::HORIZONTAL_F, "dB", channel));
		m_measurements.push_back(
			std::make_shared<M2kMeasurementData>("THD", M2kMeasurementData::HORIZONTAL_F, "dB", channel));
		m_measurements.push_back(
			std::make_shared<M2kMeasurementData>("THDN", M2kMeasurementData::HORIZONTAL_F, "dB", channel));
		m_measurements.push_back(
			std::make_shared<M2kMeasurementData>("SFDR", M2kMeasurementData::VERTICAL_F, "dBc", channel));
	}
}
...
bool M2kMeasure::highLowFromHistogram(double &low, double &high, double min, double max)
{
	bool success = false;
...
void M2kMeasure::measureTimeDomain()
{
	...
	m_cross_detect = new M2kCrossingDetection(m_cross_level, m_hysteresis_span, "P");
...
std::vector<int> M2kMeasure::LoadMaskfromFile(std::string file_name)
{
	...
	if(!mask_file.is_open())
		throw std::runtime_error("Could not open freq file");
...
M2kMeasurementData::M2kMeasurementData(const QString &name, axisType axis, const QString &unit, int channel)
	: m_name(name)
	, m_value(0)
	, m_measured(false)
	, m_enabled(false)
