...
Max14906Tool::Max14906Tool(struct iio_context *ctx, Filter *filt,
        ...
        m_max14906SettingsTab(new Max14906SettingsTab(this)),
        m_qTimer(new QTimer),
...
void Max14906Tool::setupDynamicUi(ToolLauncher *parent) {
        ...
        this->m_customColGrid = new CustomColQGridLayout(4, this); // 4 max channels
...
void Max14906Tool::connectSignalsAndSlots() {
        ...
        connect(this->m_max14906SettingsTab->getSpinButton(), &PositionSpinButton::valueChanged, this, &Max14906Tool::timerChanged);
        connect(this->m_qTimer, &QTimer::timeout, this, [&](){
                this->m_readerThread->start();
        });
        connect(this->m_readerThread, &MaxReaderThread::started, this, [&](){
...
void Max14906Tool::timerChanged() {
        for (auto & channelControl : this->m_channelControls) {
                channelControl->updateTimeScale(0, this->m_max14906SettingsTab->getSpinButton()->value());
        }
}
...
adiscope::gui::GenericMenu* Max14906Tool::createGeneralSettings(const QString& title, QColor* color) {
        ...
        this->m_max14906SettingsTab = new Max14906SettingsTab();
...
void Max14906Tool::initChannels() {
        ...
        for (int i = 0; i < channel_num - 1; ++i) { // -1 because of the fault channel
                ...
                channel_control->getDigitalChannel()->updateTimeScale(0, this->m_max14906SettingsTab->getSpinButton()->value());
