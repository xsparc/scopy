...
//	tool->topContainer()->setMaximumHeight(35);
	...
	registerDeviceList->setSizePolicy(QSizePolicy::Preferred, QSizePolicy::Preferred);
	QObject::connect(registerDeviceList, &QComboBox::currentTextChanged, this, &RegisterMapTool::updateActiveRegisterMap);
	tool->addWidgetToTopContainerHelper(registerDeviceList,TTA_LEFT);
