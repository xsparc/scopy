...
void DataLoggerGenericMenu::init(QString title, QColor *color)
{
	...
	connect(historySize, QOverload<int>::of(&QComboBox::currentIndexChanged), this,
		&DataLoggerGenericMenu::historySizeIndexChanged);
	connect(historyStyle, QOverload<int>::of(&QComboBox::currentIndexChanged), this,
